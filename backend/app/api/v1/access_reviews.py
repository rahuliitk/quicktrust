...
async def create_campaign(org_id: UUID, data: AccessReviewCampaignCreate, db: DB, current_user: CurrentUser):
...
async def get_campaign(org_id: UUID, campaign_id: UUID, db: DB, current_user: CurrentUser):
...
async def update_campaign(
    org_id: UUID, campaign_id: UUID, data: AccessReviewCampaignUpdate, db: DB, current_user: CurrentUser
):
...
async def delete_campaign(org_id: UUID, campaign_id: UUID, db: DB, current_user: CurrentUser):
...
async def list_entries(
    org_id: UUID, campaign_id: UUID, db: DB, current_user: CurrentUser,
...
async def create_entry(
    org_id: UUID, campaign_id: UUID, data: AccessReviewEntryCreate, db: DB, current_user: CurrentUser
):
